...
session("redirectPage")="https://www.multiplemonitors.co.uk/shop/pc/manpay-v3.asp"
...
If scSSL="" OR scSSL="0" Then
	tempURL=replace((scStoreURL&"/"&scPcFolder&"/pc/manpay-v3.asp"),"//","/")
	tempURL=replace(tempURL,"https:/","https://")
	tempURL=replace(tempURL,"http:/","http://") 
Else
	tempURL=replace((scSslURL&"/"&scPcFolder&"/pc/manpay-v3.asp"),"//","/")
	tempURL=replace(tempURL,"https:/","https://")
	tempURL=replace(tempURL,"http:/","http://")
End If
...
<%
 ...
 pcIdCustomer=1
pcBillingTotal=120
pcBillingAddress="21 Welton Old Rd"
pcBillingPostalCode="HU15 1NU"
pcBillingStateCode=""
pcBillingProvince=""
pcBillingCity="Welton"
pcBillingCountryCode="GB"
pcBillingTaxAmount=20
pcShippingAddress="21 Welton Old Rd"
pcShippingStateCode=""
pcShippingProvince=""
pcShippingCity="Welton"
pcShippingCountryCode="GB"
pcShippingPostalCode="HU15 1NU"
pcShippingFullName="Shipping Darren"
pcShippingFirstName="Darren"
 pcShippingLastName="Atkinson"
pcBillingAddress2="Welton Old Rd2"
pcShippingCompany="Multiple Monitors"
pcShippingAddress2="Welton Old Rd2"
pcShippingEmail="sales@multiplemonitors.co.uk"
pcShippingFax=""
pcShippingPhone="07515165843"
pcBillingFirstName="Darren"
pcBillingLastName="Atkinson"
pcBillingCompany="AtkTek Ltd"
pcBillingPhone="0845 508 53 77"
'SB S
pcSubTax=20
pcSubTrialTax=0
pcSubShipping=0
pcSubTrialShipping=0
'SB E
pcCustomerEmail="support@darrenatkinson.co.uk"
...
If request.QueryString("crypt")<>"" then
	...
	If pcv_StrStatus="OK" then
		...
		Response.redirect "manpay-ok.asp"
	Else
...
ThisVendorTxCode = session("GWOrderId") & "_" & Hour(Now) & Minute(Now) & Second(Now) & rnd()
If ProtxTestmode =1 Then
